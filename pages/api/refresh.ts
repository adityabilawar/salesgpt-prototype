...
export default async function handler(
  ...
  const { user, lead, campaign, currResult } = req.body;
  ...
  const aboutInput = `You have made a response with this prompt: ${campaign.generatedPrompt}. Rephrase the following response for the prompt: ${currResult}`;
  try {
