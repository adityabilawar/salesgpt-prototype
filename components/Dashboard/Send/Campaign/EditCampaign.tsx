      ...
      <div className="px-6 h-full">
        <div className="overflow-y-auto grid grid-cols-2 gap-10 w-full">
            ...
            <form onSubmit={handleSave} className="overflow-y-auto">
              ...
              <div className="mb-4">
                ...
                <input
                  id="call-to-action"
                  name="callToAction"
                  value={editedCampaign.callToAction}
                  onChange={handleChange}
                  className="rounded-md w-full p-2"
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  id="tone-of-voice"
                  name="toneOfVoice"
                  value={editedCampaign.toneOfVoice}
                  onChange={handleChange}
                  className="rounded-md w-full p-2"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  id="word-limit"
                  placeholder="150"
                  value={editedCampaign.wordLimit}
                  onChange={handleChange}
                  name="wordLimit"
                  className="rounded-md w-full p-2"
                />
              ...
              <div className="flex justify-end gap-x-3">
                <button
                  ...
                  className="px-4 py-2 bg-gradient-to-br from-[#01B7C5] to-[#C417E0] text-white rounded-md"
                >
                  Generate Prompt
                </button>
                <button
                  type="submit"
                  className="rounded-md bg-brand text-white px-4 py-2"
                >
                  Save
                </button>
              </div>
          ...
          <div>
            ...
            <textarea
              value={editedCampaign.generatedPrompt}
              className="w-full p-2 h-64 text-black mb-4"
              readOnly
            ></textarea>
          </div>
        </div>
